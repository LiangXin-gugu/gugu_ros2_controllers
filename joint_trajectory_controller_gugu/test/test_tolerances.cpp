...
using joint_trajectory_controller_gugu::SegmentTolerances;
...
protected:
  ...
  joint_trajectory_controller_gugu::Params params;
...
TEST_F(TestTolerancesFixture, test_get_segment_tolerances)
{
  ...
  auto active_tolerances = joint_trajectory_controller_gugu::get_segment_tolerances(
