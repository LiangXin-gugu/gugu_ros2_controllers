...
#include "joint_trajectory_controller_gugu/tolerances.hpp"
...
[[maybe_unused]] void expectDefaultTolerances(
  joint_trajectory_controller_gugu::SegmentTolerances active_tolerances)
{
...
: public joint_trajectory_controller_gugu::JointTrajectoryController
{
public:
  using joint_trajectory_controller_gugu::JointTrajectoryController::JointTrajectoryController;
  using joint_trajectory_controller_gugu::JointTrajectoryController::validate_trajectory_msg;

  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = joint_trajectory_controller_gugu::JointTrajectoryController::on_configure(previous_state);
    return ret;
  }
  ...
  joint_trajectory_controller_gugu::SegmentTolerances get_active_tolerances()
  {
  ...
  joint_trajectory_controller_gugu::SegmentTolerances get_tolerances() const
  {
